...
**Welcome to KnowzCode!**

KnowzCode is a systematic development methodology that transforms your AI assistant from a chaotic coder into a disciplined, professional software engineer. It uses a structured loop and a library of prompts to build software that is well-documented, properly tested, and robust enough for long-term maintenance.

**Why KnowzCode?**
Without structure, every AI-driven project risks the same fate: initial rapid progress followed by unmanageable complexity, outdated documentation, and eventual abandonment. KnowzCode prevents this by instilling professional software engineering practices into the AI's workflow from day one.
...
1. **Download the latest release:** [knowzcode.starter.zip](https://github.com/AlexHeadscarf/KnowzCode/releases/latest)
...
2. **Project Overview** (`knowzcode/knowzcode_project.md`)
   - Can use `knowzcode/prompts/KCv2.0__Project_Generator.md` prompt (if available)
...
3. **Architecture Diagram** (`knowzcode/knowzcode_architecture.md`)
   - Can use `knowzcode/prompts/KCv2.0__Architecture_Generator.md` prompt (if available)
...
NOW extract the KnowzCode ZIP into your project root:
...
> **`knowzcode/prompts/KCv2.0__Install_And_Reconcile.md`**

### Step 5: Verify System Readiness
After installation, run a comprehensive audit:
> **`knowzcode/prompts/KCv2.0__Post_Installation_Audit.md`**

This will:
- Verify all KnowzCode components are working
...
> **`knowzcode/prompts/KCv2.0__Start_Work_Session.md`**
...
**`knowzcode/prompts/KCv2.0__[LOOP_1A]__Propose_Change_Set.md`**
...
**`knowzcode/prompts/KCv2.0__[LOOP_1B]__Draft_Specs.md`**
...
**`knowzcode/prompts/KCv2.0__[LOOP_2A]__Implement_Change_Set.md`**
...
**`knowzcode/prompts/KCv2.0__[LOOP_2B]__Verify_Implementation.md`**
...
**`knowzcode/prompts/KCv2.0__[LOOP_3]__Finalize_And_Commit.md`**
...
```
You: knowzcode/prompts/KCv2.0__Start_Work_Session.md
...
You: knowzcode/prompts/KCv2.0__Spec_Verification_Checkpoint.md
Agent: "Specification Verification Checkpoint complete. All specs are present and meet quality standards. Ready to proceed."

You: knowzcode/prompts/KCv2.0__[LOOP_2A]__Implement_Change_Set.md
...
You: knowzcode/prompts/KCv2.0__[LOOP_2B]__Verify_Implementation.md
...
```
knowzcode/prompts/KCv2.0__Handle_Critical_Issue.md
...
```
knowzcode/prompts/KCv2.0__Refactor_Node.md
...
```
knowzcode/prompts/KCv2.0__Feature_Idea_Breakdown.md
...
| Prompt | Purpose | When to Use |
|:-------|:--------|:------------|
| `knowzcode/prompts/KCv2.0__Start_Work_Session.md` | Sync AI with project | Beginning of each session |
| `knowzcode/prompts/KCv2.0__[LOOP_1A]__Propose_Change_Set.md` | Analyze feature impact | Automatic after PrimaryGoal |
| `knowzcode/prompts/KCv2.0__[LOOP_1B]__Draft_Specs.md` | Create blueprints | After approving Change Set |
| `knowzcode/prompts/KCv2.0__Spec_Verification_Checkpoint.md` | **Quality Gate:** Verify specs are complete | Recommended for Change Sets ≥10 nodes |
| `knowzcode/prompts/KCv2.0__[LOOP_2A]__Implement_Change_Set.md` | Build and test | After approving specs (or spec verification) |
| `knowzcode/prompts/KCv2.0__[LOOP_2B]__Verify_Implementation.md` | **Quality Gate:** Audit implementation | After Loop 2A is complete |
| `knowzcode/prompts/KCv2.0__[LOOP_3]__Finalize_And_Commit.md` | Document and commit | After implementation passes audit |

### Quick Actions
| Prompt | Use Case | Typical Duration |
|:-------|:---------|:-----------------|
| `knowzcode/prompts/KCv2.0__Execute_Micro_Fix.md` | Typos, small tweaks | < 5 minutes |
| `knowzcode/prompts/KCv2.0__Handle_Critical_Issue.md` | Bugs, broken features | Varies by severity |
| `knowzcode/prompts/KCv2.0__Refactor_Node.md` | Code quality improvements | 15-60 minutes |

### Planning & Analysis
| Prompt | Purpose | Output |
|:-------|:--------|:-------|
| `knowzcode/prompts/KCv2.0__Feature_Idea_Breakdown.md` | Prioritize multiple features | Markdown report in knowzcode/planning/ |
| `knowzcode/prompts/KCv2.0__Pre_Flight_Feature_Analysis.md` | Deep analysis of one feature | Detailed implementation plan |
| `knowzcode/prompts/KCv2.0__Architecture_Health_Review.md` | Full project audit | Health score and action items |
| `knowzcode/prompts/KCv2.0__Advanced_Security_Audit.md` | OWASP-based security check | Vulnerability report |
...
**Solutions:**
- Run `knowzcode/prompts/KCv2.0__Start_Work_Session.md` to resync
...
3. Install KnowzCode with `knowzcode/prompts/KCv2.0__Install_And_Reconcile.md`
4. Start systematic development!

Remember: The first project might feel slow as you learn the workflow, but each subsequent project becomes faster and more natural. KnowzCode's true power emerges as projects grow in complexity.

Welcome to systematic, professional AI-powered development. Welcome to KnowzCode!
