# KnowzCode v2.0: [LOOP 3] Finalize & Commit Change Set
...
> **Automation Path:** Execute `/kc-step phase=3 workgroup_id=<ID>` to hand off to the `finalization-steward` subagent. It chains `tracker-update`, `log-entry-builder`, and `architecture-diff` skills to wrap up the loop.
